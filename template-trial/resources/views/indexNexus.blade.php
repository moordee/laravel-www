...
<html lang="en" id="htmlRoot">
   <head>
      ...
      <!-- Bootstrap 5.3 -->
      <link href="css/nexus/bootstrap.min.css" rel="stylesheet"/>
      <!-- AOS Animate on Scroll -->
      <link href="css/nexus/aos.css" rel="stylesheet"/>
      <!-- Swiper -->
      <link href="css/nexus/swiper-bundle.min.css" rel="stylesheet"/>
      <!-- all min css -->
      <link rel="stylesheet" href="css/nexus/all.min.css"/>
      <!-- magnific CSS -->
      <link rel="stylesheet" href="css/nexus/magnific-popup.css"/>
      <!-- Style CSS -->
      <link rel="stylesheet" href="css/nexus/style.css" />
   </head>
   <body>
      <!-- ======================== LANDING PAGE ======================== -->
      <div id="landing">
      ...
      <!-- ======================== SCRIPTS ======================== -->
      <!-- jQuery -->
      <script src="js/nexus/jquery-3.7.1.min.js"></script>
      <!-- Bootstrap 5 -->
      <script src="js/nexus/bootstrap.bundle.min.js"></script>
      <!-- AOS -->
      <script src="js/nexus/aos.js"></script>
      <!-- Swiper -->
      <script src="js/nexus/chart.umd.min.js"></script>
      <!-- CounterUp -->
      <script src="js/nexus/jquery.magnific-popup.min.js"></script>
      <!-- Main js -->
      <script src="js/nexus/main.js"></script>
   </body>
</html>
